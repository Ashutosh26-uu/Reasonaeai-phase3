...
// packages/code/src/tools/hashline/mismatch.ts.
...
export function parseTag(ref: string): { line: number } {
  ...
  // Group 1 is mandatory in `LINE_REF_RE`; the fallback only satisfies
...
export interface MismatchDetails {
  ...
  anchorLines?: readonly number[] | undefined;
   ...
   */
  hashRecognized?: boolean | undefined;
