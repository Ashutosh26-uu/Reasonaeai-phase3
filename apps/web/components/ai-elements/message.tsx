...
import {
  ButtonGroup,
  ButtonGroupText,
} from "@reasonateai/ui/components/button-group";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export type MessageResponseProps = Omit<
  ...
  "plugins" | "rehypePlugins" | "mermaid" | "linkSafety"
>;
...
if (!sanitize) {
  throw new Error("Streamdown sanitization plugin is unavailable.");
}

const safeRehypePlugins: NonNullable<
